...
export default function Tray() {
  ...
  return <main className="tray-page">
    ...
    {settings?.showToday && <section className="tray-totals">
      <div><h2>{t('tray.today')}{incomplete(usage[0]) && <span title={t('usage.incomplete')} aria-label={t('usage.incomplete')}> *</span>}</h2>{totals(usage[0]?.summary)}</div>
