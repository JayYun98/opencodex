...
Claude Desktop forwarding inherits the [fresh-connection final-send contract](../transports/responses.md#fetch-helper-import-boundary); client integration does not choose a separate provider transport.
