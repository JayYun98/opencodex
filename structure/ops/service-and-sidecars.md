...
Managed services read `OCX_FRESH_CONNECTION_HOSTS` at process start and enforce it through the [Responses final-send contract](../transports/responses.md#fetch-helper-import-boundary), including provider-scoped transports selected after revalidation.
