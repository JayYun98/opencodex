...
The [protocol-gated recovery contract](../transports/streaming-health.md#protocol-gated-http-stream-recovery) is covered by the existing retry, preflight, send-budget and WebSocket routing suites.
