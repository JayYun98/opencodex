...
Provider-scoped HTTP fetches inherit the [fresh-connection final-send contract](transports/responses.md#fetch-helper-import-boundary); runtime provider selection cannot bypass that operator policy.
