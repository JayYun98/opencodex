...
Image and sidecar sends inherit the [fresh-connection final-send contract](../transports/responses.md#fetch-helper-import-boundary); provider-scoped fetch selection cannot bypass it.
