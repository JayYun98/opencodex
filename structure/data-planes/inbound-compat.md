...
Inbound translation does not weaken the [fresh-connection final-send contract](../transports/responses.md#fetch-helper-import-boundary); the policy is applied after the destination and physical fetch are selected.
