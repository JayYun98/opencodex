...
Subagent routing preserves the [fresh-connection final-send contract](transports/responses.md#fetch-helper-import-boundary), including when credential revalidation selects a provider-scoped fetch.
