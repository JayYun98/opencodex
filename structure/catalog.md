...
Catalog derivation does not alter the [fresh-connection final-send contract](transports/responses.md#fetch-helper-import-boundary); selected provider fetches remain inside that policy boundary.
