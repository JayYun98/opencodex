...
Adapter-selected provider fetches inherit the [fresh-connection final-send contract](../transports/responses.md#fetch-helper-import-boundary); registry transport overrides do not escape it.
