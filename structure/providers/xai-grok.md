...
xAI's provider-scoped fetch remains inside the [fresh-connection final-send contract](../transports/responses.md#fetch-helper-import-boundary), so its custom transport cannot bypass an operator host match.
